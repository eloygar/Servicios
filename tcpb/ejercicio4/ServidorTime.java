...
public class ServidorTime {
	 ...
	 public static String mostrarTiempo() {
	        ...
	        System.out.println(segundos);
	        long segundosHastaMediodia = calcularSegundosHastaNoche(segundos);
	        //long segundosHastaMediodia = segundosHastaMediodia();
	        // Devolver la hora actual y los segundos restantes hasta mediodía
	        return "Hora actual: " + horaActual + "\nSegundos restantes hasta las 12 AM: " + segundosHastaMediodia+ "segundos";
	    }

	    private static long calcularSegundosHastaNoche(int segundos) {
	    	//86400
	    	//00
	    	if (segundos==86400)return (0);
		
			return (int)(86400-segundos);
