...
public class Servidor {
	...
	public static String mostrarTiempo() {
		...
		//System.out.println(segundos);
		long segundosHasta10 = calcularSegundos(segundos);
		// long segundosHastaMediodia = segundosHastaMediodia();
		// Devolver la hora actual y los segundos restantes hasta mediodía
		return "Hora actual: " + horaActual + "\n Segundos restantes hasta las 10 PM: " + segundosHasta10
				+ " segundos";
	}

	private static long calcularSegundos(long segundos) {
	    long segundos10 = 36000; 
	    long diaTotal = 86400; 

	    if (segundos == segundos10) {
	        return 0;
	    } else if (segundos > segundos10) {
	        return (diaTotal - segundos) + segundos10;
	    } else {
	        return segundos10 - segundos;
	    }
	}
