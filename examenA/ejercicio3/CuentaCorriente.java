...
class CuentaCorriente implements Serializable {
	...
	void transferencia(CuentaCorriente cuentaDestino, int dinero) {
		...
		movimientos.add("Transf. emitida de " + dinero + " € a la cuenta " + cuentaDestino.numero + " Saldo "
				+ String.format("%.2f", saldo) + " €");
		cuentaDestino.movimientos.add("Transf. recibida de " + dinero + " € de la cuenta " + cuentaDestino.numero
